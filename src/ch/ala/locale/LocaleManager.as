...
package ch.ala.locale
{
	...
	public class LocaleManager
	{
		 ...
		 * 
		 *  <p>Parameter bundles contains Objects with properties locale, bundleName and optional 
		 *  param useLinebreak (if set true, "\n" will be parsed as linebreak). 
		 *  <p><code>
		 *  [{locale:"fr_CA", bundleName:"LocalizedStrings", useLinebreak:true}, <br/>
		 *  {locale:"fr_FR", bundleName:"LocalizedStrings", useLinebreak:true}] 
		 *  </code> */
		...
		public function addBundle(locale:String, bundleName:String, 
			...
			function onComplete(event:Event):void
			{
				...
				try 
				{
					parseBundle(identifier.locale, identifier.bundleName, 
						fileStream.readUTFBytes(fileStream.bytesAvailable), identifier.useLinebreak);
					success = true;
				}
				catch(e:Error)
				{
		...
		public function set localeChain(value:Array):void { _localeChain = value; }
